...
import 'package:epic/cores/games/how_long_is_a_minute/screens/game_screen.dart';
...
enum Game {
  simonSays(
      ...
      description:
          'Simon Says is a classic memory and attention game where players must mimic sequences shapes to color.',
      rules: [
        'The game will display a sequence of shapes to color.',
